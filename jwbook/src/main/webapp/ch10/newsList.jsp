	...
	<div class="container w-75 mt-5 mx-auto">
		...
		<ul class="list-group">
			<c:forEach var="news" items="${newslist}" varStatus="status">
				<li
					class="list-group-item list-group-items-action d-flex justify-content-between align-items-center">
					...
					class="text-decoration-none">[${status.count}] ${news.title},
						...
						class="badgebg-secondary"> &times;</span></a>
				</li>
			</c:forEach>
		</ul>
		...
		<button class="btn btn-outlin-info mb-3" type="button"
